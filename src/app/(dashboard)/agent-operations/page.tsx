  ...
  return (
    <div>
      <PageHeader
        ...
        description="Scheduler, worker runs, and health for autonomous background agents. All outbound actions still require human approval."
      />
      ...
      {data && data.schedules.length > 0 ? (
        ...
        !error && (
          <EmptyState
            ...
            description="Run migration 037 in Supabase SQL Editor, set CRON_SECRET, and deploy to Vercel for background runs."
          />
        )
      )}
    </div>
