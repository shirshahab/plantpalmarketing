...
async function loadBloomData() {
  const [pieces, calendarPieces, draftQueue, performance, stats] = await Promise.all([
    getBloomContentPieces(),
    getBloomCalendarPieces(),
    getBloomDraftQueue(),
    getBloomPerformance(),
  ...
  return { pieces, calendarPieces, draftQueue, performance, stats, latestRun: stats.latestRun };
}
